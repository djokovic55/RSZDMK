...
#define DIODE_PIN 5
/// Broj milisekudni od pocetka izvrsavanja programa
volatile unsigned long ms = 0;
/**
 * pinPulse-Funkcija koja implementira traptaj
 * @param port- Input tima unsigned char- Port na kojem je potrebno implementirati trepataj
 *
 */
Funkcija koja implementira traptaj
